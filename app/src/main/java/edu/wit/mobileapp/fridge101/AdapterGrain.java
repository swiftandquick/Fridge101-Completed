...
public class AdapterGrain extends RecyclerView.Adapter<AdapterGrain.ViewHolder> {

    private Context context;

    private ArrayList<String > grainName,expDate;

    public AdapterGrain(Context context) {
        this.context = context;
        grainName = new ArrayList<>();
        grainName.add("Grain");
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        if(i==0){
            ...
            viewHolder.tvName.setText(grainName.get(i-1));
        }
    }

    @Override
    public int getItemCount() {
        return grainName.size()+1;
    }
